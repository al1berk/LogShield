...
External validation and payload metadata use public Log4Shell resources from
Fox-IT, Splunk, PayloadsAllTheThings, and Curated Intelligence
\cite{foxit_pcaps,splunk_attack_data,payloadsallthethings,curatedintel}.
